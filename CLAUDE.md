...
- [x] Phase 5: Realism & Polish (steps 41–49) — **in progress**
  ...
  - [x] Step 49: README.md — 8 sections: quick-start, CLI reference (with TMS duplicate warning), output structure, configuration table, data engineering challenges, system architecture (20-step day loop + entity hierarchy), schema evolution table, reproducibility, test/performance references
