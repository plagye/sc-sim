...
- [x] Phase 5: Realism & Polish (steps 41–49) — **in progress**
...
**Test count: 764 passing** (13 config + 63 calendar + 62 constraints + 19 generator + 18 pricing + 39 weights + 12 customers + 32 carriers/warehouses + 16 state + 14 CLI + 24 output writer + 22 integration + 6 exchange rates + 10 production + 10 orders + 10 credit check + 11 inventory movements + 14 allocation + 14 modifications + 43 phase2 integration + 12 load planning + 16 load lifecycle + 11 carrier events + 10 carrier events step27 + 11 pod + 12 returns + 12 transfers + 19 phase3 integration + 13 payments + 14 demand signals + 14 demand plans + 14 demand forecasts + 14 inventory targets + 13 master data changes + 14 snapshots + 6 schema evolution + 20 phase4 integration + 15 schema evolution orders + 12 late arriving + 14 writer hardening + 18 noise injector + 15 phase5 integration)
